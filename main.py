...
async def on_message(message):  #메시지에 반응하는 함수 (매개변수는 message)
    ...
    if message.content.startswith("!"):
        ...
        # 체크리스트
        elif message.content.startswith("!체리추가"):
        ...
        elif message.content.startswith("!체리목록"):
            await message.channel.send(check.show(message.author.id))
        elif message.content.startswith("!체리완료"):
        ...
        elif message.content.startswith("!체리제거"):
            parts = message.content.split()
        ...
        #도움말
            ...
            "\n\n[체크리스트]" \
            "\n!체리추가 [내용] : 해당 내용의 체크리스트를 추가합니다." \
            "\n!체리목록    : 현재 체크리스트를 조회합니다." \
            "\n!체리완료 [번호] : 해당 번호의 체크리스트를 완료처리합니다." \
            "\n!체리제거 [번호] : 해당 번호의 체크리스트를 제거합니다."
            )
